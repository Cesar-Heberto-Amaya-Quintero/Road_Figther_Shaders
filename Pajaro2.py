    ...
    def __init__(self,shader, posicion_id, color_id, transformaciones_id):
        ...
        self.vertices = np.array(
            [
                ...
                0.44 -0.08, -0.26 -0.022, 0.0, 1.0,  48/255, 32/255, 22/255, 1.0,  #izquierda, abajo
                0.45 -0.08, -0.2 -0.022, 0.0, 1.0,     48/255, 32/255, 22/255, 1.0, #arriba
                0.53 -0.08, -0.26 -0.022, 0.0, 1.0,    48/255, 32/255, 22/255, 1.0,   #derecha
        ...
        for angulo in range(0, 359, 5):
            ...
            self.vertices = np.append(self.vertices, np.array([componente_x, componente_y, 0.0 , 1.0, 
                            48/255, 32/255, 22/255, 1.0 ], dtype="float32"))
